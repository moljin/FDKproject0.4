document.addEventListener("DOMContentLoaded", function () {
    ...
    const newInputOption = '<div class="option-form">' +
        ...
        '                                        <input checked="" class="op-display-input mt-5" name="op_available_display" type="checkbox" value="y">' +
        '                                         / <label for="op_available_order">주문가능</label>' +
        '                                        <input checked="" class="op-order-input mt-5" name="op_available_order" type="checkbox" value="y">' +
